...
from serviexpress_api.models import Document, Enterprise, Employee, Provider, PurchaseOrderDetail, Product
from serviexpress_api.serializers.ser_document import DocumentSerializer
